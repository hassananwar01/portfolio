    ...
    >
      ...
      <div className="section-container py-20 md:py-0">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Main Content */}
          <motion.div className="space-y-4 sm:space-y-6 mb-8 sm:mb-10" variants={itemVariants}>
            <motion.h1 
            ...
            <motion.p 
              ...
              variants={itemVariants}
            >
              Driving insights and innovation through data science, engineering excellence, 
